...
export const featureCards = [
  ...
  },
  {
    ...
    copy: "Outcome, photo, and notes are logged in under 10 seconds, so no lead falls through the cracks because a rep's notes lived in their phone.",
  ...
  },
  {
    ...
    copy: "See every rep's exact location in real time, know who is on pace, and support the team before the end-of-day debrief.",
  ...
  },
  {
    ...
    copy: 'Estimate from the driveway. Signature on the porch. Payment before you leave the block. Not five tools taped together.',
...
export const workSteps = [
  ...
  },
  {
    ...
    copy: "Bring over lead lists, pre-knocked address data, and customer records via CSV or direct migration. Your history does not disappear when you switch, and it never gets held hostage.",
    width: 713,
    height: 376,
  },
  {
