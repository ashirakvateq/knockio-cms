/**
 * Work order management page interactions.
 * Scoped to #work-order-management-page. Exits if root is absent.
...
(function () {
  ...
  const root = document.getElementById("work-order-management-page");
  if (!root) return;
