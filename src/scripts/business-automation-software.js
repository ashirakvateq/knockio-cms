/**
 * Business automation page interactions.
 * Scoped to #business-automation-page. Exits if root is absent.
...
(function () {
  ...
  const root = document.getElementById("business-automation-page");
  if (!root) return;
