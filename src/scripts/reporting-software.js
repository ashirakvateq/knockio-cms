/**
 * Reporting software page interactions.
 * Scoped to #reporting-software-page. Exits if root is absent.
...
(function () {
  ...
  const root = document.getElementById("reporting-software-page");
  if (!root) return;
