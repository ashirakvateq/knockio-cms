/**
 * Business texting and calling page interactions.
 * Scoped to #business-texting-calling-page. Exits if root is absent.
...
(function () {
  ...
  const root = document.getElementById("business-texting-calling-page");
  if (!root) return;
