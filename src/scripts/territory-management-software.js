/**
 * Territory management page interactions.
 * Scoped to #territory-management-page. Exits if root is absent.
...
(function () {
  ...
  const root = document.getElementById("territory-management-page");
  if (!root) return;
