/**
 * Inventory management page interactions.
 * Scoped to #inventory-management-page. Exits if root is absent.
...
(function () {
  ...
  const root = document.getElementById("inventory-management-page");
  if (!root) return;
