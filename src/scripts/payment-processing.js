/**
 * Payment processing page interactions.
 * Scoped to #payment-processing-page. Exits if root is absent.
...
(function () {
  ...
  const root = document.getElementById("payment-processing-page");
  if (!root) return;
