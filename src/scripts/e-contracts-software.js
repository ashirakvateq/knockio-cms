/**
 * E-contracts software page interactions.
 * Scoped to #e-contracts-software-page. Exits if root is absent.
...
(function () {
  ...
  const root = document.getElementById("e-contracts-software-page");
  if (!root) return;
